/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5d1447782fe7db7cdfe58b06718a6549)
// Runtime types generated with workerd@1.20260623.1 2026-06-21 nodejs_compat
interface __BaseEnv_Env {
	SUPABASE_URL: "https://PROJECT_REF.supabase.co";
	JWT_SECRET: string;
	SUPABASE_SERVICE_ROLE_KEY: string;
	LIVE_DATA: DurableObjectNamespace<import("./src/index").LiveDataDO>;
	RATE_LIMIT: DurableObjectNamespace<import("./src/index").RateLimitDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LiveDataDO" | "RateLimitDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "JWT_SECRET" | "SUPABASE_SERVICE_ROLE_KEY">> {}
}
